...
<div className="not-prose mb-10 flex flex-col flex-wrap items-center">
  <h2>Upcoming Events</h2>
  <h3>sciwork 2025 February scisprint in NTHU CTC</h3>
  <a href="/sprint/2025/02-hsinchu.html">scisprint page</a>
</div>

<h2 className="not-prose text-center">About sciwork</h2>
