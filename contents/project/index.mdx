...
- **Project Link** [Github](https://github.com/shengwen-tw/rotor-bench)
- **Project Contact:** Sheng-Wen (Colin) Cheng (discord: @shengwen)

RotorBench is a lightweight Python-based quadrotor simulator designed for
rapid prototyping, controller benchmarking, and academic research. It
provides SE(3) rigid-body dynamics, motor and ESC models, sensor noise,
aerodynamic drag, and wind turbulence. For reinforcement learning,
RotorBench supports GPU-accelerated batched simulations to enable
