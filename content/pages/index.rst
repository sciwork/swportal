...
.. raw:: html
    ...
    <div id="upcoming-events">
        ...
        <a href="/meetup/2025/0521-nycu.html" class="flex w-full rounded-lg shadow-md no-underline overflow-hidden my-4">
          ...
          <div class="flex flex-1 flex-col justify-center p-4">
            <h4 class="text-gray-800">Meetup 2025 May 21st in NYCU</h4>
