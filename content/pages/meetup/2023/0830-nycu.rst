========================================
Meetup 2023 August 30th in NYCU
========================================
...
* 19:30-20:00 Numerical software shape the world: A brief introduction of numerical software and modmesh
...
Speaker : Chun-Hsu - A WiFi firmware engineer in Mediatek.Inc.
He is interested in numerical software development and also making contributions on modmesh.
 
This sharing will start with what numerical analysis is and why we need it. And introducing 
the sciwork project "modmesh", this sharing will not contain any math formulas, only some 
fancy figures!

modmesh Project Link: `Github <https://github.com/solvcon/modmesh>`__
...
<https://sciwork.kktix.cc/events/meetup-20230830>`__.
