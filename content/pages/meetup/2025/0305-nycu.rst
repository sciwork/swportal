  ...
  <div class="grid grid-cols-5 p-1">
    ...
    <div class="col-span-5 lg:col-span-4">
      ...
      <div>
        ...
        <div>1. How to design and define a declarative language interface for the user?</div>
        <div>2. How to abstract the implementation details in PySide6?</div>
        <div>3. How to make sure the interface is easy to use?</div>
        <div>4. How to make a plan in the beginning of this project?</div>
        <div>5. Is there any issues during the development?</div>
      </div>
    </div>
  </div>
  <hr/>
...
`PUI <https://github.com/buganini/PUI>`__ is a declarative language interface for the user
to create a GUI. It is based on PySide6 and abstracts the implementation details. Just provide
the clear and easy-to-use interface for the user.

In this session, we will discuss the following topics:

1. How to design and define a declarative language interface for the user?
...
The meetup is free. 
Please register on `discord event <https://discord.com/channels/730297880140578906/1007075707400237067/1345710531771629640>`__. 
